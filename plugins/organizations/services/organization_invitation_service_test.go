...
func TestOrganizationInvitationService_CreateOrganizationInvitation(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			userSvc.On("GetByEmail", mock.Anything, mock.Anything).Return(&models.User{}, nil).Maybe()
...
func TestOrganizationInvitationService_ListAllOrganizationInvitationsByOrgIDWithOrg(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			setup: func(invRepo *orgtests.MockOrganizationInvitationRepository) {
				invRepo.On("ListAllByOrganizationIDWithOrg", mock.Anything, "org-1", 1, pagination.DefaultMaxLimit).
