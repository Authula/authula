...
type OrganizationRepository interface {
	...
	GetAllAccessibleByUserID(ctx context.Context, userID string, page int, limit int) ([]types.Organization, int, error)
...
type OrganizationInvitationRepository interface {
	...
	GetAllByOrganizationIDWithOrg(ctx context.Context, organizationID string, page int, limit int) ([]types.GetOrganizationInvitationResponse, int, error)
	GetAllPendingByEmail(ctx context.Context, email string, limit int) ([]types.OrganizationInvitation, error)
...
type OrganizationMemberRepository interface {
	...
	GetAllByOrganizationID(ctx context.Context, organizationID string, page int, limit int) ([]types.OrganizationMember, int, error)
	GetAllByOrganizationIDWithUser(ctx context.Context, organizationID string, page int, limit int) ([]types.OrganizationMemberResponse, int, error)
...
type OrganizationTeamRepository interface {
	...
	GetAllByOrganizationID(ctx context.Context, organizationID string, page int, limit int) ([]types.OrganizationTeam, int, error)
...
type OrganizationTeamMemberRepository interface {
	...
	GetAllByTeamID(ctx context.Context, teamID string, page int, limit int) ([]types.OrganizationTeamMember, int, error)
	GetAllByTeamIDWithMemberAndUser(ctx context.Context, teamID string, page int, limit int) ([]types.OrganizationTeamMemberResponse, int, error)
